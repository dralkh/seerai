    ...
    return [
        {
            ...
            template: 'Summarize the key findings, methodology, and contributions of /. Focus on the main arguments, research methods used, and the significance of the results.',
            category: 'summary',
            tags: ['summary', 'quick-review'],
            placeholders: extractPlaceholders('Summarize the key findings, methodology, and contributions of /.'),
            createdAt: now,
            updatedAt: now,
            isBuiltIn: true,
        },
        {
            ...
            template: 'Compare the research methodologies used in / and / regarding #. Highlight key differences in approach, data collection, and analysis methods.',
            category: 'comparative',
            tags: ['methodology', 'comparison'],
            placeholders: extractPlaceholders('Compare the research methodologies used in / and / regarding #.'),
            createdAt: now,
            updatedAt: now,
            isBuiltIn: true,
        },
        {
            ...
            template: 'Based on papers in ^ on #, identify key research gaps and unexplored areas. Consider methodological limitations, understudied populations, and emerging questions.',
            category: 'analysis',
            tags: ['gap-analysis', 'research-design'],
            placeholders: extractPlaceholders('Based on papers in ^ on #, identify key research gaps.'),
            createdAt: now,
            updatedAt: now,
            isBuiltIn: true,
        },
        {
            ...
            template: 'Write a concise literature review on # covering papers by @ in ^. Synthesize the main themes, methodological approaches, and key findings.',
            category: 'writing',
            tags: ['literature-review', 'writing'],
            placeholders: extractPlaceholders('Write a concise literature review on # covering papers by @ in ^.'),
            createdAt: now,
            updatedAt: now,
            isBuiltIn: true,
        },
        {
            ...
            template: 'Analyze the methodological strengths and weaknesses of / including: research design, sample size and selection, statistical methods, validity threats, and replicability.',
            category: 'analysis',
            tags: ['methodology', 'critical-analysis'],
            placeholders: extractPlaceholders('Analyze the methodological strengths and weaknesses of /.'),
            createdAt: now,
            updatedAt: now,
            isBuiltIn: true,
        },
        {
            ...
            template: 'Explain the concept of # as it appears in the selected papers. Provide definitions, examples, and how different authors approach this concept.',
            category: 'summary',
            tags: ['explanation', 'concepts'],
            placeholders: extractPlaceholders('Explain the concept of # as it appears in the selected papers.'),
            createdAt: now,
            updatedAt: now,
            isBuiltIn: true,
        },
        {
            ...
            template: 'Provide a critical review of /. Discuss its strengths (novelty, rigor, significance) and limitations (methodology gaps, generalizability, missing perspectives). Suggest improvements.',
            category: 'analysis',
        ...
        },
        {
            ...
            template: 'Extract and list the key findings from the selected papers on #. Organize findings by theme and note any contradicting results.',
            category: 'summary',
            tags: ['findings', 'extraction'],
            placeholders: extractPlaceholders('Extract and list the key findings on #.'),
            createdAt: now,
            updatedAt: now,
            isBuiltIn: true,
        },
